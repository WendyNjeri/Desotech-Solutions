...
<head>
  ...
  <title>Desotech Solutions</title>
  <meta content="" name="description">
  <meta content="" name="keywords">

  <!-- Favicons -->
  <link href="assets/img/logo/apple-icon-57x57.png" rel="icon">
  <link href="assets/img/logo/apple-icon-57x57.png" rel="apple-touch-icon">
  ...
  <header id="header" class="header fixed-top">
    <div class="container-fluid container-xl d-flex align-items-center justify-content-between">
      ...
      <a href="index.html" class="logo d-flex align-items-center">
        <img src="assets/img/logo/banner cmp lgo.png" alt="">
        <span></span>
      </a>
      ...
      <nav id="navbar" class="navbar">
        <ul>
          ...
          <a class="nav-link scrollto" href="#portfolio">Developed Systems</a>
    ...
    <div class="container">
      <div class="row">
        ...
        <div class="col-lg-6 order-1 order-lg-2 hero-img" data-aos="zoom-out" data-aos-delay="200">
          <img src="assets/img/logo/hero-img.png" class="img-fluid" alt="">
        </div>
      </div>
    </div>
        ...
        <div class="row gx-0">
          ...
          <div class="col-lg-6 d-flex flex-column justify-content-center" data-aos="fade-up" data-aos-delay="200">
            <div class="content">
              <h3>Who We Are</h3>
              <h2>
                We are team of talented developers ready to work
                with you.
              </h2>
              <p>
                We believe that when technology is data-driven and people-centric, it maximizes the organization's impact 
                on their industry
                 and society as a whole.
                Therefore, let us serve you with the experience and professionalism acquired. 
              </p>
              <div class="text-center text-lg-start">
                <a href="about.php"
          ...
          <div class="col-lg-6 d-flex align-items-center" data-aos="zoom-out" data-aos-delay="200">
            <img src="assets/img/logo/why-us.png" class="img-fluid" alt="">
          </div>
        ...
        <div class="row gy-4">
          ...
          <div class="col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="200">
            <div class="service-box blue">
              ...
              <p>
                We provide you with IT consultancy issues related to anything Technology.
              </p>
              <a href="sales.php" class="read-more"><span>Read More</span> <i class="bi bi-arrow-right"></i></a>
            </div>
          </div>
